...
public class TwitterCreateActionTest extends TestCase {
    @Override
    ...
    public void test_execute_returns_success_and_updates_session()  {
        ...
        guestForm.setTwitter("New Twitter");
        action.setGuestForm(guestForm);

        // Session
        GuestForm previousGuestFormInSession = new GuestForm();
        previousGuestFormInSession.setNickname("New Nickname");
        previousGuestFormInSession.setCountry("New Country");
        HashMap sessionMap = new HashMap<String, Object>();
        sessionMap.put("guest", previousGuestFormInSession);
